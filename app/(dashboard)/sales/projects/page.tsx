...
import { 
  Plus, Search, Filter, Clock, MapPin, CreditCard, Briefcase,
  ArrowUpDown, Building2, Calendar
} from "lucide-react";
...
export default function ProjectsPage() {
  ...
  const [sortField, setSortField] = useState<"title" | "client" | "rate" | "startDate">("startDate");
          ...
          {sortedProjects.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                {searchTerm || filterStatus ? "検索条件に一致する案件がありません" : "案件が登録されていません"}
              </p>
