...
export const mockContracts: Contract[] = [
  {
    ...
    actionItems: [
      { id: "a1", task: "クライアントに契約更新意向を確認", completed: false, dueDate: "2025-06-20", assignee: "営業担当A" },
      { id: "a2", task: "エンジニアの継続意向を確認", completed: false, dueDate: "2025-06-22", assignee: "営業担当A" },
      { id: "a3", task: "契約書の準備・作成", completed: false, dueDate: "2025-06-25", assignee: "法務部" },
      { id: "a4", task: "契約書の締結", completed: false, dueDate: "2025-06-29", assignee: "営業担当A" },
    ],
    clientName: "〇〇商事株式会社",
  ...
  },
  {
    ...
    actionItems: [
      { id: "b1", task: "引き継ぎ資料の作成依頼", completed: true, dueDate: "2025-06-18", assignee: "佐藤花子" },
      { id: "b2", task: "後任エンジニアの選定", completed: false, dueDate: "2025-06-25", assignee: "営業担当B" },
      { id: "b3", task: "引き継ぎスケジュールの調整", completed: false, dueDate: "2025-06-28", assignee: "営業担当B" },
    ],
  ...
  },
  {
    ...
    actionStatus: "pending",
    actionItems: [
      { id: "c1", task: "契約条件の見直し", completed: false, dueDate: "2025-07-10", assignee: "営業担当C" },
      { id: "c2", task: "単価改定の検討", completed: false, dueDate: "2025-07-15", assignee: "営業担当C" },
      { id: "c3", task: "契約書の更新", completed: false, dueDate: "2025-07-25", assignee: "法務部" },
    ],
  },
  {
    id: "c4",
...
export const mockProjects: Project[] = [
  {
    ...
    workStyle: "remote",
    status: "open",
    description: "大手ECサイトのフロントエンド刷新プロジェクト。最新技術スタックを用いたリニューアル案件です。",
  ...
  },
  {
    ...
    workStyle: "onsite",
    status: "negotiating",
    description: "製造業向けIoTプラットフォームの構築案件。AI/ML技術を活用した予知保全システムの開発。",
...
// プロジェクトに最適なエンジニアを取得
export const getMatchingEngineers = (projectId: string): { engineer: Engineer; score: number }[] => {
