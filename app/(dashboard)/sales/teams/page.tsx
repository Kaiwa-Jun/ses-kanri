              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-muted-foreground">
                      利益率:{' '}
                      {((currentTargetData.profitTarget / currentTargetData.target) * 100).toFixed(
                        1
                      )}
                      %
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium">
                        {(currentTargetData.current / 10000).toFixed(0)} /{' '}
                        {(currentTargetData.target / 10000).toFixed(0)}万円
                      </span>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium">
                        {(currentTargetData.currentProfit / 10000).toFixed(0)} /{' '}
                        {(currentTargetData.profitTarget / 10000).toFixed(0)}万円
                      </span>
                    </div>
                    <Progress
                      value={
                        (currentTargetData.currentProfit / currentTargetData.profitTarget) * 100
                      }
                      className="h-3"
                    />
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>
                        達成率:{' '}
                        {(
                          (currentTargetData.currentProfit / currentTargetData.profitTarget) *
                          100
                        ).toFixed(1)}
                        %
                      </span>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center p-3 bg-primary/10 rounded-lg border border-primary/20">
                        ...
                        <span className="font-bold">
                          {(
                            (currentTargetData.costs.engineerCosts +
                              currentTargetData.costs.operatingCosts +
                              currentTargetData.costs.salesCosts) /
                            10000
                          ).toFixed(0)}
                          万円
                        </span>
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>メンバー: {team.members.length}名</CardDescription>
                  </div>
                    ...
                    <div key={member.id} className="flex items-center gap-3">
                      ...
                      <div className="text-right">
                        <p className="font-medium">
                          {(member.monthlyRevenue / 10000).toFixed(0)}万円
                        </p>
                ...
                <div className="pt-4 border-t">
                  <div className="flex justify-between items-baseline mb-2">
                    ...
                    <p className="text-xl font-bold">
                      {(team.monthlyRevenue / 10000).toFixed(0)}万円
                    </p>
                  </div>
                  <Progress value={70} className="h-2" />
                  <p className="text-xs text-right text-muted-foreground mt-1">目標達成率: 70%</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
