...
import { 
  Building2, Search, Filter, Calendar, Users, Plus, FileText,
  Mail, Phone, Star, ArrowUpDown
} from "lucide-react";
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">
            取引先企業の管理（{sortedClients.length}社）
          </p>
        </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{client.contacts[0].position}</p>
                      </div>
                    </div>
                  </TableCell>
          ...
          {sortedClients.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                {searchTerm || filterStatus ? "検索条件に一致するクライアントがありません" : "クライアントが登録されていません"}
              </p>
              <Button>
                新規クライアントを登録する
              </Button>
