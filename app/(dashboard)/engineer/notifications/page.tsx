...
export default function NotificationsPage() {
  ...
  // 未提出系の通知をグループ化
  const unsubmittedNotifications = notifications.filter(
    (n) => n.type === 'workReport' || n.type === 'timesheet'
  );

  // 工数アラート系の通知をグループ化
  const overtimeNotifications = notifications.filter((n) => n.type === 'overtime');

  // その他の通知
  const otherNotifications = notifications.filter(
    (n) => !['workReport', 'timesheet', 'overtime'].includes(n.type)
  );
    ...
    return (
      <div className="space-y-4">
        {notifications.map((notification, index) => (
          ...
          >
            <div
              className={`flex items-start justify-between gap-2 p-3 hover:bg-muted rounded-lg transition-colors ${getNotificationColor(
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>日報・工数報告の未提出があります</CardDescription>
                    </div>
                  </div>
              ...
              <CardContent>
                ...
                <div className="mb-4 p-4 bg-red-50 dark:bg-red-950/20 rounded-lg border border-red-200 dark:border-red-800">
                  ...
                  <Button asChild className="w-full bg-red-600 hover:bg-red-700 text-white">
                    <Link href="/engineer/reports?tab=bulk">まとめて提出する</Link>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>工数の超過・不足に関するアラート</CardDescription>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge
