...
export default function EngineerDashboardPage() {
  ...
  // 今月の稼働時間
  const monthlyHours = workReports.reduce(
    (total, report) => total + report.workingHours + report.overtimeHours,
    0
  );
    ...
    <div className="container py-6 space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">こんにちは、{engineer.name}さん</p>
        </div>
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>現在参加中の案件情報</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-4 border-b">
                ...
                <div className="sm:ml-auto text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      勤務形態:{' '}
                      {currentProject.workStyle === 'remote'
                        ? 'リモート'
                        : currentProject.workStyle === 'onsite'
                          ? '常駐'
                          : 'ハイブリッド'}
                    </span>
                  </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">{currentProject.description}</p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>稼働時間の集計と報告状況</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" asChild>
                <Link href="/engineer/reports">稼働報告を入力する</Link>
              </Button>
            </CardFooter>
          </Card>
        </motion.div>
                  ...
                  <Badge
                    ...
                    ${
                      engineer.availability === 'available'
                        ...
                        : engineer.availability === 'partially'
              ...
              <div className="pt-4 border-t space-y-4">
                ...
                <div className="flex justify-between">
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/engineer/skills">スキル情報を編集</Link>
                  </Button>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {pastProjects.slice(0, 2).map((project) => (
                <div key={project.id} className="flex flex-col py-2">
                  <div className="flex justify-between items-start mb-1">
                    <h4 className="font-medium">{project.name}</h4>
                    <Badge variant="outline" className="text-xs">
                      {project.startDate.substring(0, 7)} 〜{' '}
                      {project.endDate ? project.endDate.substring(0, 7) : '現在'}
                    </Badge>
                  </div>
