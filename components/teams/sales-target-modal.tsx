...
export function SalesTargetModal({ 
  ...
  const form = useForm<TargetFormValues>({
    ...
    defaultValues: {
      ...
      targetDate: "",
      averageProjectValue: currentData?.projectAnalysis?.averageValue ? currentData.projectAnalysis.averageValue / 10000 : 0,
  ...
  const getDatePlaceholder = () => {
    switch (watchedValues.period) {
      case "月次": return "2025-06";
      case "四半期": return "2024-Q2";
      case "年次": return "2024";
      default: return "";
    }
  };
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline">
                      {watchedValues.period === "月次" ? calculateRequiredDeals() : 
                       watchedValues.period === "四半期" ? Math.ceil(calculateRequiredDeals() / 3) :
                       Math.ceil(calculateRequiredDeals() / 12)}件/月
                    </Badge>
                  </div>
                </div>
